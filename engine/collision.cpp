...
namespace Collision {
     ...
     * @param Object1 First object sprite
     * @param Object2 Second object sprite
     * @param AlphaLimit Alpha limit
     ...
     * @param LoadInto Texture to load image
     * @param Filename
     * @return False if the file could not be opened for some reason
     */
